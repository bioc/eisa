...
<<conditions-plots-dysreg-real,width=10,height=8,echo=FALSE,results=hide>>=
png("cond-dysreg.png", width=800, height=400)
<<conditions-plots-dysreg>>
dev.off()
@

\begin{figure}
\includegraphics[width=\textwidth]{cond-dysreg.png}
...
<<B1-cond-plots-real,echo=FALSE,results=hide,width=10,height=8>>=
png("cond-dysreg2.png", width=800, height=400)
<<B1-cond-plots>>
dev.off()
@ 
\begin{figure}
\centering
\includegraphics[width=\textwidth]{cond-dysreg2.png}
